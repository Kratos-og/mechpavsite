        ...
        {props.init && props.loadVal !== 100 && (
          <AnimatePresence>
            <motion.div
              ...
              className="flex items-end justify-end w-full px-40"
            >
          ...
          {isInView && (
            <div className="w-full z-40 relative text-[11px] ml-[15%] tracking-widest">
              <div className="w-1/4 flex -mt-10 relative">
                ...
                >
                  <div>
                    CARDANO&apos;S BIGGEST NFT MINT IS HAPPENING RIGHT HERE ON{" "}
                    <b>OCTOBER 19TH</b>.
                  </div>
                  <div>
                    5 CLASSES, 5 PARTS, 5 SKINS AND OVER 1 MILLION COMBINATIONS.
                    COLLECT AND BUILD INTERCHANGEABLE MECH PARTS TO BUILD A
                    FULLY USEABLE AVATAR.
                  </div>
                </motion.div>
              </div>
            </div>
