        ...
        <SwiperSlide key={item.split('.')[1]}>
            <div className="text-sm flex flex-col gap-3">
                ...
                {!props.selected?.includes(item) ?
                    ...
                    :
                    <div onClick={() => props.onRemove(item)} className="bg-red-400 hover:bg-red-500 cursor-pointer transition-all w-fit font-bold text-black uppercase m-auto px-3 py-1 rounded-full whitespace-nowrap">
                        Remove Selection
                    </div>
                }
