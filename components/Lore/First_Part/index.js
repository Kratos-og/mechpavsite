    ...
    <div className="h-screen w-screen lg:px-40 px-10 flex flex-col justify-center">
      <div className=" flex lg:gap-10 gap-2 max-md:flex-col-reverse">
        <div className="w-full">
          <p className="lg:text-2xl font-bold border-b-[1px] border-white lg:pb-3 lg:mb-3 mb-1">PAVS</p>
          <p className="lg:text-sm text-justify text-[0.60rem]">
          PAVS are 4-legged creatures from the planet Pavia. They are light-dependant animals that can create energy and clean air by converting sunlight within their bodies. They are composed of a variety of unknown elements believed to be derived from nearby meteors and asteroids from local solar systems. PAVS are incredibly resistant and even have the unique ability to regenerate lost limbs, though this process has been found to be slow. PAVS are curious and inquisitive in nature and though they are extremely loyal, generally avoid interactions with humans. They are telepathic and have no vocal cords to speak so communicate by producing grunts and whistles from time to time. They can often be found in rough terrains such as mountains and forests and although harmless at first glance, they can be aggressive when threatened and have been known to seriously injure humans due to their short temperament.
          </p>
        </div>
        <div className="lg:w-[40rem]">
          <img src="assets/images/pav.png" alt="hi" className="rounded-xl max-md:h-24 w-full object-cover" />
        </div>
      </div>
      <div>
        <p className="lg:text-2xl font-bold border-b-[1px] border-white lg:pb-3 lg:mb-3 mb-1">Origins</p>
      ...
      <div>
        <p className="lg:text-2xl font-bold border-b-[1px] border-white lg:pb-3 lg:my-3 mb-1">Settlement on Pavia</p>
        <p className="lg:text-sm text-[0.60rem] text-justify">It is believed that since the crash that brought them here, PAVS would spread across the land, multiplying and evolving into different forms. Over the next 40 years, their bodies would produce enough energy and oxygen to transform the atmosphere into breathable air, and in the few years leading up to the Horizon landing the lands across Pavia would grow grass, trees, plants and eventually form rivers and oceans, becoming habitable for humanity. In the year 2AP, the first PAVS would be discovered by humans and it is said that the very first PAV ever spotted was golden.</p>
      </div>
    </div>
  );
}
