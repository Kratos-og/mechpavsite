...
const PavDetails = props => {
    return (
        <div className="w-full h-full rounded-xl md:p-10 relative">
            <div className="flex gap-6 flex-wrap md:overflow-auto py-4 border-secondary relative">
                ...
                <Item image="eye" value={props.eyeColor} name="Eye Color">
                    Pavs' mesmerising eyes boast a range of vibrant colours, from deep space blue to cosmic greens.
                </Item>
