    ...
    return (
        <motion.svg className="scroll" viewBox="0 0 82 97" fill="none" xmlns="http://www.w3.org/2000/svg" >
            <motion.path
                ...
                className="scroll__mouse" d="M38.5 25L33 30V51.5L38.5 56H45L50 51.5V30L45 25H38.5Z" stroke="currentColor" ></motion.path>
            <motion.line
                initial={{ pathLength: 0 }}
                animate={{ pathLength: 1 }}
                transition={{ delay: 1 }}
                className="scroll__line" x1="42" y1="32" x2="42" y2="40" stroke="currentColor" stroke-width="2" ></motion.line>
            <motion.path
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1, duration: 1 }}
                className="scroll__tri" d="M39.0003 69.8275L41.8279 72.6551L44.6554 69.8275H39.0003Z" fill="currentColor" ></motion.path>
            <motion.path
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1.5, duration: 1 }}
                className="scroll__tri" d="M39.0003 81.8275L41.8279 84.6551L44.6554 81.8275H39.0003Z" fill="currentColor" ></motion.path>
            <motion.path
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 2, duration: 1 }}
                className="scroll__tri" d="M39.0003 93.8275L41.8279 96.6551L44.6554 93.8275H39.0003Z" fill="currentColor" ></motion.path>
            <motion.path
                initial={{ pathLength: 0, pathOffset: 0 }}
                animate={{ pathLength: 1, pathOffset: [0, 0.1, 1] }}
                transition={{
                    duration: 1,
                    delay: 2,
                    ease: "easeInOut",
            ...
            <motion.path
                initial={{ pathLength: 0, pathOffset: 0 }}
                animate={{ pathLength: 1, pathOffset: [0, 0, 0, 0, 1] }}
                transition={{
                    delay: 2.1,
                    duration: 1,
                    ease: "easeInOut",
