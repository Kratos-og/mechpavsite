    ...
    return (
        <motion.svg className="scroll" viewBox="0 0 82 97" fill="none" xmlns="http://www.w3.org/2000/svg" >
            ...
            <motion.line
                ...
                animate={{ pathLength: 1 }}
                transition={{ delay: 1 }}
                className="scroll__line" x1="42" y1="32" x2="42" y2="40" stroke="#14fecd" stroke-width="2" ></motion.line>
            <motion.path
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1, duration: 1 }}
                className="scroll__tri" d="M39.0003 69.8275L41.8279 72.6551L44.6554 69.8275H39.0003Z" fill="#14fecd" ></motion.path>
            <motion.path
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1.5, duration: 1 }}
                className="scroll__tri" d="M39.0003 81.8275L41.8279 84.6551L44.6554 81.8275H39.0003Z" fill="#14fecd" ></motion.path>
            <motion.path
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 2, duration: 1 }}
                className="scroll__tri" d="M39.0003 93.8275L41.8279 96.6551L44.6554 93.8275H39.0003Z" fill="#14fecd" ></motion.path>
            <motion.path
