...
const RightArmAnnotation = (props) => {
  ...
  return (
    ...
    >
      <div
        className="w-5 h-5 rounded-full bg-white rotate-180"
        onMouseEnter={() => {
          setDisplay(true);
        }}
        onMouseLeave={() => {
        ...
        <AnimatePresence>
          {display && (
            <>
              ...
              <motion.div initial={{opacity:0}} animate={{opacity:[0,1,0,0,1,0,1],transition:{delay:0.5,duration:0.5}}} className="px-20 bg-white/20 border-2 border-white ml-[170px] mb-[25%] rounded-md rotate-180">
