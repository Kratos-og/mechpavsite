const data = {
  torso: [
    ...
    },
    {
      ...
      skin: { BE_Code: "CS", BE_Name: "Recon", FE_Code: "DB", FE_Name: "Deep Blue" },
      type: { name: "Hydra", BE_Code: "DSE" },
    },
    {
      model: "MP_DSE_ELM_Body", img: "Hydra_Torso_EM_thumb",
      skin: { BE_Code: "ELM", BE_Name: "Elemental", FE_Code: "EM", FE_Name: "Emerald" },
      type: { name: "Hydra", BE_Code: "DSE" },
    },
    {
    ...
    },
    {
      ...
      skin: { BE_Code: "CS", BE_Name: "Recon", FE_Code: "DG", FE_Name: "Digital" },
      type: { name: "Recon", BE_Code: "DSP" },
    },
    {
    ...
    },
    {
      ...
      skin: { BE_Code: "ELM", BE_Name: "Elemental", FE_Code: "MR", FE_Name: "Mars" },
      type: { name: "Recon", BE_Code: "DSP" },
    },
    {
    ...
    },
    {
      ...
      skin: { BE_Code: "CS", BE_Name: "Recon", FE_Code: "CM", FE_Name: "Commando" },
    ...
    {
      model: "MP_DEF_LGD_Body", img: "Defender_Torso_NV_thumb",
      skin: { BE_Code: "LGD", BE_Name: "Legendary", FE_Code: "NV", FE_Name: "Nova" },
      type: { name: "Defender", BE_Code: "DEF" },
    },
    {
      model: "MP_DEF_ELM_Body", img: "Defender_Torso_OB_thumb",
      skin: { BE_Code: "ELM", BE_Name: "Elemental", FE_Code: "OB", FE_Name: "Orbital" },
      type: { name: "Defender", BE_Code: "DEF" },
    },
    {
    ...
    },
    {
      ...
      skin: { BE_Code: "ELM", BE_Name: "Elemental", FE_Code: "PR", FE_Name: "Purple Rain" },
      type: { name: "Reactor", BE_Code: "NRG" },
    },
    {
      model: "MP_NRG_CS_Body", img: "Reactor_Torso_PU_thumb",
      skin: { BE_Code: "CS", BE_Name: "Recon", FE_Code: "PU", FE_Name: "Pulsar" },
      type: { name: "Reactor", BE_Code: "NRG" },
    },
  ],
  leftarm: [
  ...
  backpack: [
    ...
    {
      model: "MP_DEF_LGD_Backpack", img: "Defender_Back Pack_NV_thumb",
      skin: { BE_Code: "LGD", BE_Name: "Legendary", FE_Code: "NV", FE_Name: "Nova" },
      type: { name: "Defender", BE_Code: "DEF" },
    },
    {
  ...
  legs: [
    ...
    {
      model: "MP_DEF_LGD_Legs", img: "Defender_Legs_NV_thumb",
      skin: { BE_Code: "LGD", BE_Name: "Legendary", FE_Code: "NV", FE_Name: "Nova" },
      type: { name: "Defender", BE_Code: "DEF" },
    },
    {
